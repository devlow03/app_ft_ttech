...
class CreateReviewLogic extends GetxController {
  ...
  Future<void> uploadImageToFirebase(File imageFile, String filename) async {
    ...
    final response = await dio.post(
        "https://firebasestorage.googleapis.com/v0/b/appfttmart-3c6e3.appspot.com/o?uploadType=media&name=comments/$productId/$filename.png",
        data: formData);
    if (response.data is Map<String, dynamic>) {
      postUploadFileRsp.value =
          PostUploadFileRsp.fromJson(response.data as Map<String, dynamic>);
    } else {
      return;
    }
  }
