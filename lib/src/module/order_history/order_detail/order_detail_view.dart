    ...
    return Obx(() {
      ...
      return Scaffold(
          ...
          bottomNavigationBar: BottomAppBar(
              child: Visibility(
            visible: logic.getOrderByIdRsp.value?.data?.statusCode ==
                    "cancelled" ||
                logic.getOrderByIdRsp.value?.data?.statusCode == "delivered" ||
                logic.getOrderByIdRsp.value?.data?.statusCode == "returned",
            replacement: Padding(
