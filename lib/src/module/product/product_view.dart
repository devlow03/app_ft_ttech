                                    ...
                                    children: [
                                      Text(
                                          "${logic.indexSlider.value +
                                              1}/${logic.getProductByIdRsp.value
                  ...
                  actions: [
                    IconButton(
                        ...
                        icon: Obx(() {
                          return Visibility(
                            visible: logic.getProductByIdRsp.value?.data
                                ?.favorite == true || logic.isFavorites.value==true,
                                        ...
                                        InkWell(
                                          onTap: () {
                                            Get.to(AllProductByCategoryPage(
                                              ...
                                              categoryName: logic.getProductRsp
                                                  .value?.data?.first
                                                  .categoryName,
                                            ));
                                          },
