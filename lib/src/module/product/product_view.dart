...
import 'package:app_ft_tmart/src/widget/photo_view.dart';
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                Text("${logic.indexSlider.value + 1}/${data
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Visibility(
                        visible: data?.galleryImagesUrl?.isEmpty == false,
