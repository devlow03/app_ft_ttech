    ...
    return WillPopScope(
      ...
      child: Scaffold(
                    ...
                    Obx(() {
                      return Stack(
                        ...
                        children: [
                          ...
                          Visibility(
                            visible: logicCart.getCartRsp.value?.data?.cartDetails?.isNotEmpty==true,
                            child: Positioned(
                              right: 5,
                              bottom: 25,
                              child: Container(
                  ...
                  child: Obx(() {
                    return Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: logic.getProductByIdRsp.value?.data.isNull ==
                              false,
                          replacement: Center(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () {
                                                Get.to(
                                                    ListProductPage(name: logic.getProductRsp.value?.data?.first.categoryName??"",));
                                              },
                                              child: Row(
                                                children: [
                                                  Text(
        ...
        bottomNavigationBar: Obx(() {
          return Visibility(
            visible: logic.getProductByIdRsp.value?.data?.thumpnailUrl
                ?.isNotEmpty == true,
            child: BottomAppBar(
              height: 150,
